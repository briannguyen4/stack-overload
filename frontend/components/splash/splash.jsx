    ...
    <div className="splash">
        <div className="splash-img">
            ...
            <div className="splash-img__text">
                ...
                <p className="splash-img__text__sentence">We build products that empower developers
                and connect them to solutions that enable productivity, growth, and discovery.</p>
            </div>
        </div>
        <div className="splash-message">
            ...
            <div className="splash-message__text">
                <p>Welcome to Stack Overload, an open community for all coders. Get answers immediately
                 from a community of knowledgeable programmers. Search through a collection of questions
                 or create an account to ask your own!</p>
            </div>    
        </div>
    </div>
